...
class BPDetailChartWidget extends StatelessWidget {
  ...
  BPDetailChartWidget(this.readings,
      {super.key,
      this.height = 200,
  ...
  void processReadingsData() {
    ...
    secondaryLineColor = Palette.hrLineColor;
              ...
              dotData: FlDotData(
                ...
                getDotPainter: (spot, percent, barData, index) {
                  return FlDotCirclePainter(
                    ...
                    color: secondaryLineColor,
                    strokeWidth: 1,
                    strokeColor: secondaryLineColor,
                  );
                },
              ),
            ),
